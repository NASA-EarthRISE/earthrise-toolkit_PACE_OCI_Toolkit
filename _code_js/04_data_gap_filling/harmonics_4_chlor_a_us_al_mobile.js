...
var pt = ee.Geometry.Point([-87.9879, 30.3137]); // An area inside the Mobile Bay, Alabama
...
print(ui.Chart.image.series(chlor_a.select('chlor_a'), pt, ee.Reducer.mean(), 4000)
    .setOptions({title: 'PACE OCI - chlor_a - Mobile Bay, Alabama, USA', lineWidth: 1, pointSize: 3, vAxis: {title: 'Chlorophyll a conc.'}, series:{0:{color:'blue'}}}));
