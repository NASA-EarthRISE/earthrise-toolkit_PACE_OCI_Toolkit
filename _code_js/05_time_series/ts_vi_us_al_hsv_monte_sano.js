...
// Plot just one VI (EVI) - 8 day
print(ui.Chart.image.series(c.pace_oci_8d_global_evi, pt1, ee.Reducer.mean(), 4000)
...
Map.addLayer(c.pace_oci_mt_conus_202505, b.viz3, "PACE OCI SR (4km) - May 2025*", 0);
